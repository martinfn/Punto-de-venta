    ...
    <main>
        <div class="container-fluid">
            ...
            <?php if(isset($validation)){?>
                ...
                <?php } ?>
            <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>/configuracion/nuevo_arqueo" autocomplete="off">
            <?php echo csrf_field(); ?>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <input class="form-control" id="monto_inicial" name="monto_inicial" value="" type="text" required>
                        </div>
                    </div>
                </div>
