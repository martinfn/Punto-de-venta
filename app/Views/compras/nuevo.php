...
<div id="layoutSidenav_content">
            ...
            <form method="POST" id="form_compra" name="form_compra" action="<?php echo base_url(); ?>/compras/guarda" autocomplete="off">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12 col-sm-4">
                            ...
                            <input class="form-control" id="precio_compra" name="precio_compra" type="text" disable>
                        </div>
                        ...
                        <div class="col-12 col-sm-4">
                            ...
                            cantidad.value,'<?php echo $id_compra; ?>',unidad_t.value)"> Agregar producto</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12 col-sm-4">
                            ...
                            <input class="form-control" id="unidad_t" name="unidad_t" type="text" disabled>
                            <br>
                        </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 offset-md-6">
                        ...
                        <button type="button" id="completa_compra" class="btn btn-success">
    ...
    let precio = document.getElementById("precio_compra");
    cantidad.addEventListener("change", () => {
            subtotal.value = parseFloat(precio.value) * parseFloat(cantidad.value)
                        ...
                        success: function(resultado) {
                            if (resultado == 0) {
                                ...
                                if (resultado.existe) {
                                    ...
                                    $("#cantidad").focus();
                                    $("#unidad_t").val(resultado.datos.unidad_t);
                                } else {
                                    $("#id_producto").val('');
                                    $("#nombre").val('');
                                    $("#cantidad").val('');
        ...
        function agregarProducto(id_producto, cantidad, id_compra,proporcion) {

            if (id_producto != null && id_producto != 0 && cantidad > 0) {
                $.ajax({
                    url: '<?php echo base_url(); ?>/TemporalCompra/insertar2/' + id_producto +
                        "/" + cantidad + "/" + id_compra + "/"+ proporcion + "/"+ precio.value ,
